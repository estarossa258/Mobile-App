...
var browser = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  fetch: fetch$1,
  "default": nodeFetch,
  Headers: Headers$1,
...
class RealtimeClient {
  ...
  connect() {
    ...
    __vitePreload(() => import("./browser.960229ac.js").then(function(n) {
      return n.b;
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  boxes.forEach(function(box, index) {
    ...
    box.addEventListener("click", function() {
      ...
      var isClicked2 = box.classList.contains("clicked");
      localStorage.setItem("boxClicked-" + index, isClicked2);
    });
  });
});
export { successNotification as a, errorNotification as e, supabase as s };
